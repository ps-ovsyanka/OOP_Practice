...
namespace Laba_11
{
    public class Toy : Goods
    {
        ...
        public static Toy CreateRandom()
        {
            ...
            string name = arrName[Program.rand.Next(arrName.Length - 1)];
            string manufacturer = arrManufact[Program.rand.Next(arrManufact.Length - 1)];
            int price = Program.rand.Next(100, 5000);
